    ...
    <body>
        ...
        <section class="home-section">
            ...
            <div class="upload-content">
                ...
                ?>
                <h1>Upload File PDF MAINTANCE LEADER</h1>
                <hr>
                <b>Judul:</b> <?php echo $data['judul'];?> | <a href='index.php'> Kembali </a>
                <hr>
                <embed src="../manager/file/<?php echo $data['nama_file'];?>" type="application/pdf" width="800" height="600" >
            </div>

    ...
    <body>
        <div class="sidebar close">
            ...
            <ul class="sub-menu">
                ...
                <li><a href="../../hr/manager/">Manager</a></li>
                <li><a href="../../hr/spv/">SPV</a></li>
                <li><a href="../../hr/staff/">Staff</a></li>
                <li><a href="../../hr/leader/">Leader</a></li>
                <li><a href="../../hr/admin/">Admin</a></li>
            </ul>
            </li>
            <li>
            <div class="iocn-link">
            ...
            <ul class="sub-menu">
                ...
                <li><a href="../finance_manager/">Finance Manager</a></li>
                <li><a href="index.php">Finance Analisis</a></li>
            </ul>
            </li>
            <li>
        ...
        <section class="home-section">
            ...
            <div class="upload-content">
                ...
                ?>
                <h1>Upload File PDF FINANCE ANALISIS</h1>
                <hr>
                <b>Judul:</b> <?php echo $data['judul'];?> | <a href='index.php'> Kembali </a>
                <hr>
                <embed src="../finance_manager/file/<?php echo $data['nama_file'];?>" type="application/pdf" width="800" height="600" >
            </div>
